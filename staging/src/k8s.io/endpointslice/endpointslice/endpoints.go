...
func FromEndpoints(
	...
	desiredEndpointSlicesByAddrTypePort := map[addrTypePortMapKey]*EndpointPortAddressType{}
	...
	for _, subset := range subsets {
		...
		for _, address := range subset.Addresses {
			...
			epHash := newAddrTypePortMapKey(endpointPorts, *addrType)
...
func (lafe *LabelsAnnotationsFromEndpoints) Set(logger klog.Logger, epSlice *discovery.EndpointSlice, controllerName string) (map[string]string, map[string]string, bool) {
	updated := false
