...
type AllocatedDeviceStatusApplyConfiguration struct {
	...
	NetworkDeviceInfo *NetworkDeviceInfoApplyConfiguration `json:"networkDeviceInfo,omitempty"`
}
...
func (b *AllocatedDeviceStatusApplyConfiguration) WithRequest(value string) *AllocatedDeviceStatusApplyConfiguration {
	b.Request = &value
	return b
}
...
func (b *AllocatedDeviceStatusApplyConfiguration) WithDeviceInfo(value runtime.RawExtension) *AllocatedDeviceStatusApplyConfiguration {
	b.DeviceInfo = &value
	return b
}

// WithNetworkDeviceInfo sets the NetworkDeviceInfo field in the declarative configuration to the given value
// and returns the receiver, so that objects can be built by chaining "With" function invocations.
// If called multiple times, the NetworkDeviceInfo field is set to the value of the last call.
func (b *AllocatedDeviceStatusApplyConfiguration) WithNetworkDeviceInfo(value *NetworkDeviceInfoApplyConfiguration) *AllocatedDeviceStatusApplyConfiguration {
	b.NetworkDeviceInfo = value
	return b
}
