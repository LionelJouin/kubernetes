...
type NetworkDeviceDataApplyConfiguration struct {
	...
	Addresses     []NetworkAddressApplyConfiguration `json:"addresses,omitempty"`
...
func (b *NetworkDeviceDataApplyConfiguration) WithAddresses(values ...*NetworkAddressApplyConfiguration) *NetworkDeviceDataApplyConfiguration {
	for i := range values {
		if values[i] == nil {
