...
var map_NetworkAddress = map[string]string{
	"":     "NetworkAddress provides a network address related details such as IP and Mask.",
	"cidr": "CIDR contains the network address in CIDR notation, which includes both the address and the associated subnet mask. e.g.: \"192.0.2.0/24\" for IPv4 and \"2001:db8::/64\" for IPv6.",
}

func (NetworkAddress) SwaggerDoc() map[string]string {
	return map_NetworkAddress
}
...
var map_NetworkDeviceData = map[string]string{
	...
	"addresses":     "Addresses lists the network addresses assigned to the device's network interface. This can include both IPv4 and IPv6 addresses.",
