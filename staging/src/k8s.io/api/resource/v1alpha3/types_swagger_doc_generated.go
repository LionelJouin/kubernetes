...
var map_AllocatedDeviceStatus = map[string]string{
	...
	"deviceInfo":        "DeviceInfo contains Arbitrary driver-specific data.",
	"networkDeviceInfo": "NetworkDeviceInfo contains network-related information specific to the device.",
}
...
var map_NetworkDeviceInfo = map[string]string{
	"":          "NetworkDeviceInfo provides network-related details for the allocated device. This information may be filled by drivers or other components to configure or identify the device within a network context.",
	"interface": "Interface specifies the name of the network interface associated with the allocated device. This might be the name of a physical or virtual network interface.",
	"ips":       "IPs lists the IP addresses assigned to the device's network interface. This can include both IPv4 and IPv6 addresses.",
	"mac":       "Mac represents the MAC address of the device's network interface.",
}

func (NetworkDeviceInfo) SwaggerDoc() map[string]string {
	return map_NetworkDeviceInfo
}
...
var map_ResourceClaimStatus = map[string]string{
	...
	"deviceStatuses":        "DeviceStatuses contains the status of each device allocated for this claim, as reported by the driver. This can include driver-specific information. Entries are owned by their respective drivers.",
}
