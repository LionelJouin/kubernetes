...
func (in *AllocatedDeviceStatus) DeepCopyInto(out *AllocatedDeviceStatus) {
	*out = *in
	...
	in.DeviceInfo.DeepCopyInto(&out.DeviceInfo)
	in.NetworkDeviceInfo.DeepCopyInto(&out.NetworkDeviceInfo)
	return
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *NetworkDeviceInfo) DeepCopyInto(out *NetworkDeviceInfo) {
	*out = *in
	if in.IPs != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new NetworkDeviceInfo.
func (in *NetworkDeviceInfo) DeepCopy() *NetworkDeviceInfo {
	if in == nil {
		return nil
	}
	out := new(NetworkDeviceInfo)
	in.DeepCopyInto(out)
	return out
}
