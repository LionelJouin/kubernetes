...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*resourcev1alpha3.NetworkAddress)(nil), (*resource.NetworkAddress)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha3_NetworkAddress_To_resource_NetworkAddress(a.(*resourcev1alpha3.NetworkAddress), b.(*resource.NetworkAddress), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*resource.NetworkAddress)(nil), (*resourcev1alpha3.NetworkAddress)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_resource_NetworkAddress_To_v1alpha3_NetworkAddress(a.(*resource.NetworkAddress), b.(*resourcev1alpha3.NetworkAddress), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1alpha3_AllocatedDeviceStatus_To_resource_AllocatedDeviceStatus(in *resourcev1alpha3.AllocatedDeviceStatus, out *resource.AllocatedDeviceStatus, s conversion.Scope) error {
	...
	if err := Convert_v1alpha3_NetworkDeviceData_To_resource_NetworkDeviceData(&in.NetworkData, &out.NetworkData, s); err != nil {
		return err
	}
	return nil
}
...
func autoConvert_resource_AllocatedDeviceStatus_To_v1alpha3_AllocatedDeviceStatus(in *resource.AllocatedDeviceStatus, out *resourcev1alpha3.AllocatedDeviceStatus, s conversion.Scope) error {
	...
	out.Conditions = *(*[]v1.Condition)(unsafe.Pointer(&in.Conditions))
	out.Data = *(*[]runtime.RawExtension)(unsafe.Pointer(&in.Data))
	if err := Convert_resource_NetworkDeviceData_To_v1alpha3_NetworkDeviceData(&in.NetworkData, &out.NetworkData, s); err != nil {
		return err
	}
	return nil
}
...
func autoConvert_v1alpha3_NetworkAddress_To_resource_NetworkAddress(in *resourcev1alpha3.NetworkAddress, out *resource.NetworkAddress, s conversion.Scope) error {
	out.CIDR = in.CIDR
	return nil
}

// Convert_v1alpha3_NetworkAddress_To_resource_NetworkAddress is an autogenerated conversion function.
func Convert_v1alpha3_NetworkAddress_To_resource_NetworkAddress(in *resourcev1alpha3.NetworkAddress, out *resource.NetworkAddress, s conversion.Scope) error {
	return autoConvert_v1alpha3_NetworkAddress_To_resource_NetworkAddress(in, out, s)
}

func autoConvert_resource_NetworkAddress_To_v1alpha3_NetworkAddress(in *resource.NetworkAddress, out *resourcev1alpha3.NetworkAddress, s conversion.Scope) error {
	out.CIDR = in.CIDR
	return nil
}

// Convert_resource_NetworkAddress_To_v1alpha3_NetworkAddress is an autogenerated conversion function.
func Convert_resource_NetworkAddress_To_v1alpha3_NetworkAddress(in *resource.NetworkAddress, out *resourcev1alpha3.NetworkAddress, s conversion.Scope) error {
	return autoConvert_resource_NetworkAddress_To_v1alpha3_NetworkAddress(in, out, s)
}
...
func autoConvert_v1alpha3_NetworkDeviceData_To_resource_NetworkDeviceData(in *resourcev1alpha3.NetworkDeviceData, out *resource.NetworkDeviceData, s conversion.Scope) error {
	...
	out.Addresses = *(*[]resource.NetworkAddress)(unsafe.Pointer(&in.Addresses))
...
func autoConvert_resource_NetworkDeviceData_To_v1alpha3_NetworkDeviceData(in *resource.NetworkDeviceData, out *resourcev1alpha3.NetworkDeviceData, s conversion.Scope) error {
	out.InterfaceName = in.InterfaceName
	out.Addresses = *(*[]resourcev1alpha3.NetworkAddress)(unsafe.Pointer(&in.Addresses))
	out.HWAddress = in.HWAddress
	return nil
}
