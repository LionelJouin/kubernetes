...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*v1.Network)(nil), (*core.Network)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1_Network_To_core_Network(a.(*v1.Network), b.(*core.Network), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*core.Network)(nil), (*v1.Network)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_core_Network_To_v1_Network(a.(*core.Network), b.(*v1.Network), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1_Network_To_core_Network(in *v1.Network, out *core.Network, s conversion.Scope) error {
	out.PodNetworkName = in.PodNetworkName
	out.PodNetworkAttachmentName = in.PodNetworkAttachmentName
	out.InterfaceName = in.InterfaceName
	out.IsDefaultGW4 = in.IsDefaultGW4
	out.IsDefaultGW6 = in.IsDefaultGW6
	return nil
}

// Convert_v1_Network_To_core_Network is an autogenerated conversion function.
func Convert_v1_Network_To_core_Network(in *v1.Network, out *core.Network, s conversion.Scope) error {
	return autoConvert_v1_Network_To_core_Network(in, out, s)
}

func autoConvert_core_Network_To_v1_Network(in *core.Network, out *v1.Network, s conversion.Scope) error {
	out.PodNetworkName = in.PodNetworkName
	out.PodNetworkAttachmentName = in.PodNetworkAttachmentName
	out.InterfaceName = in.InterfaceName
	out.IsDefaultGW4 = in.IsDefaultGW4
...
// Convert_core_Network_To_v1_Network is an autogenerated conversion function.
func Convert_core_Network_To_v1_Network(in *core.Network, out *v1.Network, s conversion.Scope) error {
	return autoConvert_core_Network_To_v1_Network(in, out, s)
}
...
func autoConvert_v1_PodSpec_To_core_PodSpec(in *v1.PodSpec, out *core.PodSpec, s conversion.Scope) error {
	...
	out.Networks = *(*[]core.Network)(unsafe.Pointer(&in.Networks))
	return nil
}
...
func autoConvert_core_PodSpec_To_v1_PodSpec(in *core.PodSpec, out *v1.PodSpec, s conversion.Scope) error {
	...
	out.Networks = *(*[]v1.Network)(unsafe.Pointer(&in.Networks))
	return nil
}
